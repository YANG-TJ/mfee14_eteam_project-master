...
import './usersDiscountNotCanUse.css'

function UsersDiscountNotCanUse(props) {
            ...
            discount.map((v) => {
              return (
                <div className="usersDiscountText" key={v.dId}>
                  ...
                  <div className="usersDiscountAdd">{v.created_at}</div>
                </div>
              )
            })}
        </div>
...
export default withRouter(UsersDiscountNotCanUse)
